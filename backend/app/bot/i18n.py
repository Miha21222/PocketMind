...
BOT_I18N: dict[str, dict[str, str]] = {
    ...
    "uk": {
        ...
        "help_text": "Нагадування PocketMind приходять у цей чат. Використовуйте кнопки в нагадуванні, щоб завершити завдання або відкласти його.",
        ...
        "deadline": "Дедлайн",
        "waiting_done": "✅ Відповідь отримав",
        "waiting_snooze": "🔴 Нагадати пізніше",
        "recurring_done": "✅ Зроблено зараз",
        ...
        "cb_marked_done": "Позначено як виконано",
